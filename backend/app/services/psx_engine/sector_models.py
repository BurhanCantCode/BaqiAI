...
# Import base models (optional - not all features used in BAQI AI context)
try:
    from app.services.psx_engine.stacking_ensemble import StackingEnsemble, AdaptiveStackingEnsemble
except ImportError:
    StackingEnsemble = None
    AdaptiveStackingEnsemble = None
