...
async def generate_recommendation(user_id: int) -> dict:
    """
    Run the full AI recommendation pipeline for a user.

    1. Fetch user profile + transactions from Supabase
    ...
    crew_inputs = {
        ...
        "baqi_amount": analysis["baqi_amount"] / 6,  # Monthly average
    ...
    return {
        ...
        "spending_analysis": {
            ...
            "monthly_baqi": round(analysis["baqi_amount"] / 6, 2),
        },
        "risk_profile": user.get("risk_profile", "moderate"),
